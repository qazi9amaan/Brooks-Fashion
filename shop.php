                       ...
                       <div class="col">
                           ...
                           <section   id="featured-associate" class="recomended-sec hide-mob mt-5 pt-0  ">
                                ...
                                <div class="row bg-orange no-gutters card-lift--cursor">
                                    <div  class="col-lg-6 position-absolute img-position"><img id="featured-img" src="/images/fashion.svg" class="  img-fluid" /> </div>
                                    <div class="container">
                                    <div class="row py-5">
                                        <div class="col-lg-6">
                                        <div class="p-3"> 
                                            <h3 class="mb-3 text-white text-uppercase">HIGHLY RECOMMENDS <small>By Brooks</small></h3>
                            ...
                            <div class="container show-mob mt-0  pt-3 align-content-center text-center category-name-holder align-content-center">
                                    <p type="button" id="sidebarCollapse" onclick="openNav()" class="p-2 px-5  btn-block cat-btn border hov-pointer rounded shadow">Tap for categories &nbsp;<i class="fa fa-bars"></i> </p>
                                    <h2 id="<?php echo $category ?>">HIGHLY RECOMMENDS</h2>
                            </div>
                            <section class="static about-sec mt-3">
                                <div class="container-fluid">
