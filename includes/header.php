        ...
        <div class="main-menu">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="noti_mob navbar-toggler  mr-0" >
                        <span>
                        <a href="" style="color:rgba(0,0,0,.5); font-size:25px;">
                        
                         <span class="badge p-1">
                             <i class="fa fa-bell-o"></i>
                             <small style="background:#ff9700;" class="badge badge-pill text-white">4</small></span></a>
                        </span>
