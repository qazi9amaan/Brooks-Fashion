    ...
    <section class="static about-sec">
        <div class="container">
            ...
            United Colors of Benetton, FCUK, Timberland, Avirate, FabIndia and Biba to name a few..</p>
            </div>
         
            <p class="text-justify"><strong>Brook's</strong> value proposition revolves around giving consumers 
