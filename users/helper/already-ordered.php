...
?>
        <?php 
        unset($_SESSION['completed-payment_order_id']);
...
<link rel="stylesheet" href="/css/categories-f.css">
    ...
    <section class="slider my-3 mb-4 ">
        ...
        <h1 class="font-weight-light text-uppercase p-3">Completed!</h1>

        <p type="button" 
        id="show-cat-btn" 
        data-state="close" 
        class="p-2 px-2  text-center btn-block cat-btn border hov-pointer rounded shadow">
        Your order has successfully been placed. If you wish for another order please follow back!.
      </p>
      <a href="/shop.php" class="btn w-50 text-center mx-auto mt-2">SHOP</a>
